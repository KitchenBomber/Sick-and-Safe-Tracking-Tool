...
const AboutPage = () => (
  <div>
    <div>
      ...
      <p className="blockText">Coming soon! You'll be able to view all employee and supervisor information created for your org. You'll have the full access of a supervisor user for all supervisors reporting to you. Additionally, you will be able to move employees between teams and update end of year carryover hours. These features are currently unavailable.</p>
