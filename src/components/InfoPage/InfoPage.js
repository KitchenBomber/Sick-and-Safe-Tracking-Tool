...
const InfoPage = () => (
  <div>
    ...
    <h5 style={{ color: "#CB4335" }}>ATTENTION: This application can only be as accurate as the data provided to it. If you find discrepancies examine your source data. Making corrections is easy!!</h5>
